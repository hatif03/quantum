...
example_retriever = LlmAgent(
    model=KB_RETRIEVER_MODEL,
    name="example_retriever",
    description="Retrieves relevant TikZ examples from local knowledge base using semantic/vector search.",
...
KBRetrieverAgent = example_retriever