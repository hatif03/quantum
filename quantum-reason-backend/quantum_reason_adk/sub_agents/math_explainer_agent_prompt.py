"""Math explainer agent prompt for Quantum Reason."""
...
- If context from a diagram workflow is in state, reference it in diagram_connection
- Write reasoning_trace so a demo video can show K2 Think's chain-of-thought value

Store your JSON in state via output_key math_explanation.
"""
